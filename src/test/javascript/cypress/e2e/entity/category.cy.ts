...
describe('Category e2e test', () => {
  ...
  const categorySample = { name: 'though neighboring' };
  ...
  describe('new Category page', () => {
    ...
    it('should create an instance of Category', () => {
      cy.get(`[data-cy="name"]`).type('amongst');
      cy.get(`[data-cy="name"]`).should('have.value', 'amongst');

      cy.get(`[data-cy="description"]`).type('across between');
      cy.get(`[data-cy="description"]`).should('have.value', 'across between');

      cy.get(`[data-cy="createdAt"]`).type('2026-04-02T10:25');
      cy.get(`[data-cy="createdAt"]`).blur();
      cy.get(`[data-cy="createdAt"]`).should('have.value', '2026-04-02T10:25');

      cy.get(`[data-cy="updatedAt"]`).type('2026-04-02T22:49');
      cy.get(`[data-cy="updatedAt"]`).blur();
      cy.get(`[data-cy="updatedAt"]`).should('have.value', '2026-04-02T22:49');
