...
describe('CartItem e2e test', () => {
  ...
  const cartItemSample = { quantity: 23285 };
  ...
  describe('new CartItem page', () => {
    ...
    it('should create an instance of CartItem', () => {
      cy.get(`[data-cy="quantity"]`).type('27936');
      cy.get(`[data-cy="quantity"]`).should('have.value', '27936');

      cy.get(`[data-cy="price"]`).type('8685.68');
      cy.get(`[data-cy="price"]`).should('have.value', '8685.68');
